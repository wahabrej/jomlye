class FavoriteListModel {
    ...
    factory FavoriteListModel.fromJson(Map<String, dynamic> json) => FavoriteListModel(
        movies: json["movies"] == null ? [] : List<FavoriteMovie>.from(json["movies"]!.map((x) => FavoriteMovie.fromJson(x))),
        tvShows: json["tv_shows"] == null ? [] : List<dynamic>.from(json["tv_shows"]!.map((x) => x)),
        liveTvs: json["live_tvs"] == null ? [] : List<dynamic>.from(json["live_tvs"]!.map((x) => x)),
    );
}
