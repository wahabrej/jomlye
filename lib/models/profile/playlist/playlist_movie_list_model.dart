...
//             ? []
//             : List<PlayListMovie>.from(json["play_list_videos"]!
...
class PlaylistMovieListModel {
    ...
    factory PlaylistMovieListModel.fromJson(Map<String, dynamic> json) => PlaylistMovieListModel(
        ...
        playListVideos: json["play_list_videos"] == null ? [] : List<PlayListVideo>.from(json["play_list_videos"]!.map((x) => PlayListVideo.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "playlist_details": playlistDetails?.toJson(),
        "play_list_videos": playListVideos == null ? [] : List<dynamic>.from(playListVideos!.map((x) => x.toJson())),
    };
}
...
class PlayListVideo {
    ...
    final List<Cast>? director;
    final List<Cast>? writer;
    final List<RelatedMovie>? relatedMovies;
    ...
    Map<String, dynamic> toJson() => {
        ...
        "director": director == null ? [] : List<dynamic>.from(director!.map((x) => x.toJson())),
        "writer": writer == null ? [] : List<dynamic>.from(writer!.map((x) => x.toJson())),
