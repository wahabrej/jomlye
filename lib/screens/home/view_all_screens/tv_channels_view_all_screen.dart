          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                kH8sizedBox,
                if (homeController.isApplyClicked.value || homeController.viewAllTextEditingController.text.trim().toString()!="")
                    Row(
                      children: [
                        Text(
                          ksFiltered.tr,
                        ...
                        InkWell(
                            onTap: () async {
                              ...
                              homeController.viewAllTextEditingController.clear();
                              homeController.isViewAllSearchSuffixShow.value = false;
                              await homeController.getTvChannel();
                            },
                            child: Text(
                              ksClearAll.tr,
            ...
            if(homeController.isApplyClicked.value) kH16sizedBox,
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Obx(() => FeaturedTvChannelsContentContainer(
                          containerWidth: 94.w,
