                        ...
                        : NotificationListener<ScrollNotification>(
                            onNotification: (scrollNotification) {
                              if (homeController.movieListScrollController
                                ...
                                homeController.movieListScrolled.value = true;
                                if (homeController.movieList.isNotEmpty) {
                                  homeController.getMoreMovieList(homeController
                                              .selectedTitle.value ==
                                          ksNewRelease
                                      ? "newRelease"
                                      : homeController.selectedTitle.value ==
                            ...
                            child: Expanded(
                              child: SingleChildScrollView(
                                controller:
                                    homeController.movieListScrollController,
                                child: Column(
                                  children: [
                                    GridView.builder(
                                      shrinkWrap: true,
                                            ...
                                            if (homeController
                                              ...
                                              Get.find<AllVideoPlayerController>().videoPlayerFunction(
                                                  ...
                                                  fileUrl: homeController
                                                      .movieServerList[0]
                                                      ?.fileUrl,
                                                  fileSource: homeController.movieServerList[0]?.fileSource);
                                            }
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return Obx(() => GestureDetector(
                          onTap: () {
                            homeController.selectedSortId.value = index + 1;
                            homeController.selectedSort.value = homeController
                                    .movieSortList[index]
                                    .toString()
                                    .capitalizeFirst ??
                                "";
