                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                                child: Text(
                                    "Enjoy unrestricted access to thousands of shows and movies with minimal ads.",
                        ...
                        Row(
                          children: [
                            ...
                            kW10sizedBox,
                            Expanded(
                                child: Text("Watch on your favorite devices",
                                    style: regular14TextStyle(cWhiteColor)
                                        .copyWith(height: 1.5),
                                    overflow: TextOverflow.clip)),
                          ],
                        ...
                        Row(
                          children: [
                            ...
                            kW10sizedBox,
                            Expanded(
                                child: Text("Switch plans or cancel anytime",
                                    style: regular14TextStyle(cWhiteColor)
                                        .copyWith(height: 1.5),
                                    overflow: TextOverflow.clip)),
                          ],
                        ...
                        Row(
                          children: [
                            ...
                            kW10sizedBox,
                            Expanded(
                                child: Text("World famous movies, Dramas, TVs.",
                                    style: regular14TextStyle(cWhiteColor)
                                        .copyWith(height: 1.5),
                                    overflow: TextOverflow.clip)),
                          ],
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                                child: Text(
                                    "Download from thousands of titles to watch",
                                    style: regular14TextStyle(cWhiteColor)
                                        .copyWith(height: 1.5),
                                    overflow: TextOverflow.clip)),
                          ],
