            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => InkWell(
                    ...
                    onTap: () {
                      profileController.selectedLanguageIndex.value = 0;
                      profileController.changeLanguage("English");
                    },
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return Obx(() => InkWell(
                        ...
                        highlightColor: cTransparentColor,
                        onTap: () {
                          profileController.selectedLanguageIndex.value =
                              index + 1;
                              profileController.changeLanguage(profileController.languageList[index]);
                        },
                        child: CommonLanguageWidget(
                          languageName: profileController.languageList[index],
                          borderColor:
                              profileController.selectedLanguageIndex.value ==
                                      index + 1
                                  ? cPrimaryColor
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                    width: 1.5.h, color: borderColor ?? cWhiteColor)),
            child: Container(
              decoration:
